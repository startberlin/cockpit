        ...
        <View style={WRAPPER}>
          ...
          <View style={CONTENT}>
            ...
            <View style={{ marginTop: "22mm" }}>
              <View style={{
                backgroundColor: C.brand, paddingHorizontal: 10, paddingVertical: 4,
                alignSelf: "flex-start", marginBottom: "8mm",
              }}>
                <Text style={{
                  fontFamily: "Avenir", fontWeight: 700,
                  textTransform: "uppercase", letterSpacing: 1.3,
                  fontSize: 8, color: C.white,
                }}>Appendix {data.letter}</Text>
              </View>
              <Text style={{
                fontFamily: "Avenir", fontWeight: 900,
                fontSize: 48, lineHeight: 0.95, color: C.brand,
              }}>{data.title}</Text>
            </View>
          </View>
