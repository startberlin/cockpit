...
import { cancelMembershipAction } from "../../cancel-action";
...
export function StepDetails({
  ...
  const { execute, isPending } = useAction(cancelMembershipAction, {
    ...
    >
            ...
            render={({ field, fieldState }) => (
              <Field data-invalid={fieldState.invalid}>
                ...
                <FieldDescription className="text-sm text-muted-foreground -mt-2">
                  We'll send you a departure confirmation to this email.
                </FieldDescription>
                <Input
                  {...field}
                  id={field.name}
              ...
              >
                ...
                <div className="flex flex-col gap-1">
                  <FieldLabel htmlFor="confirmedAccountsClosed">
                    I understand that all my START Berlin accounts, including my
                    email address {companyEmail}, will be permanently closed
                    immediately after this cancellation is finalised.
                  </FieldLabel>
                </div>
              </Field>
            )}
      ...
      <div className="flex gap-3">
        <Button type="button" variant="outline" asChild>
          <Link href="/membership/cancel/confirm">Back</Link>
        </Button>
        <Button
          type="submit"
          variant="destructive"
        ...
        >
          {isPending ? "Submitting…" : "Cancel membership"}
        </Button>
      </div>
    </form>
  );
