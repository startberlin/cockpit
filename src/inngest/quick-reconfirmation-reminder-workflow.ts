...
// have a reconfirmation pending after 1h, send a single reminder email. Idempotent
// per userId so duplicate completion events collapse to one outstanding loop.
